      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10, marginBottom: 16 }}>
          {[
            ...
            { label: 'Obsazenost Nýřany', value: locationOccupancy('Nýřany') },
          ...
          <div style={s.modal} onClick={e => e.target === e.currentTarget && setShowAddModal(false)}>
            <div style={s.modalBox}>
              ...
              <select style={s.select} value={newSlot.name} onChange={e => {
                ...
                setNewSlot({ ...newSlot, name, ...getSlotDefaults(name, newSlot.date) })
              }}>
    ...
    <div>
      ...
      <div style={s.statsRow}>
        {[
          ...
          { label: 'Obsazenost Nýřany', value: locationOccupancy('Nýřany'), sub: 'skupinové' },
